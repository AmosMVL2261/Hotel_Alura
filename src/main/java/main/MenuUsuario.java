...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    lblNewLabel_1.setBounds(180, 11, 390, 42);
	    ...
	    labelFecha.setBounds(35, 64, 330, 36);
	    ...
	    lblNewLabel.setBounds(302, 234, 160, 46);
	    ...
	    labelDescripcion_1.setBounds(311, 345, 598, 88);
	    ...
	    lblNewLabel_3.setBounds(312, 444, 400, 27);
	    ...
	    lblNewLabel_3_2.setBounds(312, 520, 400, 27);
